...
#define NODE_LRWAN_DATARATE_ADR		NODE_LRWAN_BASE + 0
...
#define NODE_LRWAN_MODE_ADR			NODE_LRWAN_CONFIRM_ADR + NODE_LRWAN_CONFIRM_LEN
...
#define NODE_IO_PORT_5_ADR			NODE_IO_PORT_3_ADR + NODE_IO_PORT_3_LEN
